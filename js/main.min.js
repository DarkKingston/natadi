...
selectSingle_title.addEventListener('click', () => {
    if ('active' === selectSingle.getAttribute('data-state')) {
        ...
        $(".__select").click(function() {
            $(".__select").removeClass('select_ok');
          }); 
    } else {
        selectSingle.setAttribute('data-state', 'active');
        $(".__select").click(function() {
            $(".__select").addClass('select_ok');
          });
    }
});
...
! function (e, t) {
    ...
    b.fn = b.prototype = {
        ...
        for ("boolean" == typeof a && (u = a, a = arguments[s] || {}, s++), "object" == typeof a || h(a) || (a = {}), s === l && (a = this, s--); s < l; s++)
            if (null != (e = arguments[s]))
                for (t in e) r = e[t], "__proto__" !== t && a !== r && (u && r && (b.isPlainObject(r) || (i = Array.isArray(r))) ? (n = a[t], o = i && !Array.isArray(n) ? [] : i || b.isPlainObject(n) ? n : {}, i = !1, a[t] = b.extend(u, o, r)) : void 0 !== r && (a[t] = r));
        return a
    }, b.extend({
    ...
    var T =
         ...
         */
        function (e) {
            var t, n, r, i, o, a, s, l, u, c, f, p, d, h, g, m, v, y, x, b = "sizzle" + 1 * new Date,
                w = e.document,
                T = 0,
                C = 0,
                S = le(),
            ...
            try {
                H.apply(D = P.call(w.childNodes), w.childNodes), D[w.childNodes.length].nodeType
            } catch (e) {
                H = {
            ...
            function Ce(e, t, n, r, i, o) {
                return r && !r[b] && (r = Ce(r)), i && !i[b] && (i = Ce(i, o)), ue((function (o, a, s, l) {
                    var u, c, f, p = [],
                        ...
                        m = !e || !o && t ? g : Te(g, p, e, s, l),
                        v = n ? i || (o ? e : h || r) ? [] : a : m;
                    if (n && n(m, v, s, l), r)
                        for (u = Te(v, d), r(u, [], s, l), c = u.length; c--;)(f = u[c]) && (v[d[c]] = !(m[d[c]] = f));
                    if (o) {
                        if (i || e) {
                            if (i) {
                            ...
                            for (c = v.length; c--;)(f = v[c]) && (u = i ? O(o, f) : p[c]) > -1 && (o[u] = !(a[u] = f))
                        }
                    } else v = Te(v === a ? v.splice(h, v.length) : v), i ? i(null, a, v, l) : H.apply(a, v)
                }))
            }
                    ...
                    if (n = r.relative[e[l].type]) p = [be(we(p), n)];
                        ...
                        if ((n = r.filter[e[l].type].apply(null, e[l].matches))[b]) {
                            ...
                            return Ce(l > 1 && we(p), l > 1 && xe(e.slice(0, l - 1).concat({
                                value: " " === e[l - 2].type ? "*" : ""
                            })).replace(F, "$1"), n, l < i && Se(e.slice(l, i)), i < o && Se(e = e.slice(i)), i < o && xe(e))
                        }
                        p.push(n)
                    } return we(p)
            }
                        ...
                        var n = t.length > 0,
                            ...
                            o = function (o, a, s, l, c) {
                                var f, h, m, v = 0,
                                    ...
                                    k = C.length;
                                for (c && (u = a == d || a || c); y !== k && null != (f = C[y]); y++) {
                                    if (i && f) {
                                ...
                                if (v += y, n && y !== v) {
                                    ...
                                    H.apply(l, b), c && !o && b.length > 0 && v + t.length > 1 && se.uniqueSort(l)
                                }
                                return c && (T = S, u = w), x
                            };
                        return n ? ue(o) : o
    ...
    (b.fn.init = function (e, t, n) {
        ...
        if (n = n || j, "string" == typeof e) {
            ...
            if (r[1]) {
                if (t = t instanceof b ? t[0] : t, b.merge(this, b.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : m, !0)), A.test(r[1]) && b.isPlainObject(t))
    ...
    b.fn.extend({
        ...
        contents: function (e) {
            return null != e.contentDocument && r(e.contentDocument) ? e.contentDocument : (E(e, "template") && (e = e.content || e), b.merge([], e.childNodes))
        }
    }, (function (e, t) {
        b.fn[e] = function (n, r) {
                ...
                add: function () {
                    return o && (n && !t && (s = o.length - 1, a.push(n)), function t(n) {
                        b.each(n, (function (n, r) {
                            h(r) ? e.unique && u.has(r) || o.push(r) : r && r.length && "string" !== x(r) && t(r)
                        }))
                ...
                i = {
                    ...
                    then: function (t, r, i) {
                                ...
                                var s = this,
                                    ...
                                    u = function () {
                                        ...
                                        if (!(t < o)) {
                                            ...
                                            u = e && ("object" == typeof e || "function" == typeof e) && e.then, h(u) ? i ? u.call(e, a(o, n, O, i), a(o, n, _, i)) : (o++, u.call(e, a(o, n, O, i), a(o, n, _, i), a(o, n, O, n.notifyWith))) : (r !== O && (s = void 0, l = [e]), (i || n.resolveWith)(s, l))
                                        }
                                    },
                                    c = i ? u : function () {
                                        try {
                                            ...
                                            b.Deferred.exceptionHook && b.Deferred.exceptionHook(e, c.stackTrace), t + 1 >= o && (r !== _ && (s = void 0, l = [e]), n.rejectWith(s, l))
                                        }
                                    };
                        ...
                        return b.Deferred((function (e) {
                            n[0][3].add(a(0, e, h(i) ? i : O, e.notifyWith)), n[1][3].add(a(0, e, h(t) ? t : O)), n[2][3].add(a(0, e, h(r) ? r : _))
                        })).promise()
                    },
                    promise: function (e) {
    ...
    function $() {
        m.removeEventListener("DOMContentLoaded", $), e.removeEventListener("load", $), b.ready()
    }
    ...
    }), b.ready.then = I.then, "complete" === m.readyState || "loading" !== m.readyState && !m.documentElement.doScroll ? e.setTimeout(b.ready) : (m.addEventListener("DOMContentLoaded", $), e.addEventListener("load", $));
        ...
        data: function (e, t) {
            ...
            if (void 0 === e) {
                if (this.length && (i = G.get(o), 1 === o.nodeType && !Y.get(o, "hasDataAttrs"))) {
                    for (n = a.length; n--;) a[n] && 0 === (r = a[n].name).indexOf("data-") && (r = V(r.slice(5)), K(o, r, i[r]));
    ...
    function ue(e, t) {
        for (var n, r, i = [], o = 0, a = e.length; o < a; o++)(r = e[o]).style && (n = r.style.display, t ? ("none" === n && (i[o] = Y.get(r, "display") || null, i[o] || (r.style.display = "")), "" === r.style.display && oe(r) && (i[o] = le(r))) : "none" !== n && (i[o] = "none", Y.set(r, "display", n)));
    ...
    function xe(e, t, n, r, i) {
        for (var o, a, s, l, u, c, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; d < h; d++)
            ...
            for (a = a || f.appendChild(t.createElement("div")), s = (de.exec(o) || ["", ""])[1].toLowerCase(), l = ge[s] || ge._default, a.innerHTML = l[1] + b.htmlPrefilter(o) + l[2], c = l[0]; c--;) a = a.lastChild;
    ...
    b.event = {
        ...
        add: function (e, t, n, r, i) {
            var o, a, s, l, u, c, f, p, d, h, g, m = Y.get(e);
            if (U(e))
                for (n.handler && (n = (o = n).handler, i = o.selector), i && b.find.matchesSelector(ne, i), n.guid || (n.guid = b.guid++), (l = m.events) || (l = m.events = Object.create(null)), (a = m.handle) || (a = m.handle = function (t) {
                        return void 0 !== b && b.event.triggered !== t.type ? b.event.dispatch.apply(e, arguments) : void 0
                    }), u = (t = (t || "").match(P) || [""]).length; u--;) d = g = (s = be.exec(t[u]) || [])[1], h = (s[2] || "").split(".").sort(), d && (f = b.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = b.event.special[d] || {}, c = b.extend({
                    type: d,
                    origType: g,
                    data: r,
                    handler: n,
                    ...
                    namespace: h.join(".")
                }, o), (p = l[d]) || ((p = l[d] = []).delegateCount = 0, f.setup && !1 !== f.setup.call(e, r, h, a) || e.addEventListener && e.addEventListener(d, a)), f.add && (f.add.call(e, c), c.handler.guid || (c.handler.guid = n.guid)), i ? p.splice(p.delegateCount++, 0, c) : p.push(c), b.event.global[d] = !0)
        },
        remove: function (e, t, n, r, i) {
            var o, a, s, l, u, c, f, p, d, h, g, m = Y.hasData(e) && Y.get(e);
            if (m && (l = m.events)) {
                for (u = (t = (t || "").match(P) || [""]).length; u--;)
                    if (d = g = (s = be.exec(t[u]) || [])[1], h = (s[2] || "").split(".").sort(), d) {
                        for (f = b.event.special[d] || {}, p = l[d = (r ? f.delegateType : f.bindType) || d] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = o = p.length; o--;) c = p[o], !i && g !== c.origType || n && n.guid !== c.guid || s && !s.test(c.namespace) || r && r !== c.selector && ("**" !== r || !c.selector) || (p.splice(o, 1), c.selector && p.delegateCount--, f.remove && f.remove.call(e, c));
                        a && !p.length && (f.teardown && !1 !== f.teardown.call(e, h, m.handle) || b.removeEvent(e, d, m.handle), delete l[d])
                    } else
                        for (d in l) b.event.remove(e, d + t[u], n, r, !0);
            ...
            if (l.delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, l)) {
                for (a = b.event.handlers.call(this, l, u), t = 0;
                    ...
                    for (l.currentTarget = i.elem, n = 0;
                        (o = i.handlers[n++]) && !l.isImmediatePropagationStopped();) l.rnamespace && !1 !== o.namespace && !l.rnamespace.test(o.namespace) || (l.handleObj = o, l.data = o.data, void 0 !== (r = ((b.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, s)) && !1 === (l.result = r) && (l.preventDefault(), l.stopPropagation()));
            ...
            if (l && u.nodeType && !("click" === e.type && e.button >= 1))
                for (; u !== this; u = u.parentNode || this)
                    if (1 === u.nodeType && ("click" !== e.type || !0 !== u.disabled)) {
                        for (o = [], a = {}, n = 0; n < l; n++) void 0 === a[i = (r = t[n]).selector + " "] && (a[i] = r.needsContext ? b(i, this).index(u) > -1 : b.find(i, this, null, [u]).length), a[i] && o.push(r);
                        o.length && s.push({
                            elem: u,
                            handlers: o
                        })
        ...
        special: {
            ...
            click: {
                setup: function (e) {
                    var t = this || e;
                    return pe.test(t.type) && t.click && E(t, "input") && ke(t, "click", we), !1
                },
                trigger: function (e) {
                    var t = this || e;
                    return pe.test(t.type) && t.click && E(t, "input") && ke(t, "click"), !0
                },
                _default: function (e) {
                    var t = e.target;
                    return pe.test(t.type) && t.click && E(t, "input") && Y.get(t, "click") || E(t, "a")
                }
            },
            beforeunload: {
    ...
    function Pe(e, t, n, r) {
        ...
        var i, a, s, l, u, c, f = 0,
            ...
            m = t[0],
            v = h(m);
        if (v || p > 1 && "string" == typeof m && !d.checkClone && Ae.test(m)) return e.each((function (i) {
            var o = e.eq(i);
            v && (t[0] = m.call(this, i, o.html())), Pe(o, t, n, r)
        }));
        if (p && (a = (i = xe(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === i.childNodes.length && (i = a), a || r)) {
            for (l = (s = b.map(me(i, "script"), De)).length; f < p; f++) u = i, f !== g && (u = b.clone(u, !0, !0), l && b.merge(s, me(u, "script"))), n.call(e[f], u, f);
            if (l)
                for (c = s[s.length - 1].ownerDocument, b.map(s, qe), f = 0; f < l; f++) u = s[f], he.test(u.type || "") && !Y.access(u, "globalEval") && b.contains(c, u) && (u.src && "module" !== (u.type || "").toLowerCase() ? b._evalUrl && !u.noModule && b._evalUrl(u.src, {
    ...
    function Oe(e, t, n) {
        for (var r, i = t ? b.filter(t, e) : e, o = 0; null != (r = i[o]); o++) n || 1 !== r.nodeType || b.cleanData(me(r)), r.parentNode && (n && re(r) && ve(me(r, "script")), r.parentNode.removeChild(r));
        return e
    }
    b.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (t)
                if (n)
                    for (o = o || me(e), a = a || me(s), r = 0, i = o.length; r < i; r++) Le(o[r], a[r]);
                else Le(e, s);
    ...
    function $e(e, t, n) {
        ...
        return (n = n || Re(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || re(e) || (a = b.style(e, t)), !d.pixelBoxStyles() && _e.test(a) && Ie.test(t) && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = i, s.maxWidth = o)), void 0 !== a ? a + "" : a
    }
    ...
    function Ke(e, t, n) {
        ...
        return (!d.boxSizingReliable() && i || !d.reliableTrDimensions() && E(e, "tr") || "auto" === a || !parseFloat(a) && "inline" === b.css(e, "display", !1, r)) && e.getClientRects().length && (i = "border-box" === b.css(e, "boxSizing", !1, r), (o = s in e) && (a = e[s])), (a = parseFloat(a) || 0) + Je(e, t, n || (i ? "border" : "content"), o, r, a) + "px"
    }
        ...
        style: function (e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, a, s = V(t),
                    l = Xe.test(t),
                    u = e.style;
                if (l || (t = Ve(s)), a = b.cssHooks[t] || b.cssHooks[s], void 0 === n) return a && "get" in a && void 0 !== (i = a.get(e, !1, r)) ? i : u[t];
                "string" === (o = typeof n) && (i = ee.exec(n)) && i[1] && (n = ae(e, t, i), o = "number"), null != n && n == n && ("number" !== o || l || (n += i && i[3] || (b.cssNumber[s] ? "" : "px")), d.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, r)) || (l ? u.setProperty(t, n) : u[t] = n))
            }
        },
        css: function (e, t, n, r) {
            var i, o, a, s = V(t);
            return Xe.test(t) || (t = Ve(s)), (a = b.cssHooks[t] || b.cssHooks[s]) && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = $e(e, t, r)), "normal" === i && t in Ge && (i = Ge[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i
        }
    }), b.each(["height", "width"], (function (e, t) {
        b.cssHooks[t] = {
            get: function (e, n, r) {
                if (n) return !Ue.test(b.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Ke(e, t, r) : Me(e, Ye, (function () {
                    return Ke(e, t, r)
                }))
            },
            set: function (e, n, r) {
                var i, o = Re(e),
                    ...
                    l = r ? Je(e, t, r, s, o) : 0;
                return s && a && (l -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(o[t]) - Je(e, t, "border", !1, o) - .5)), l && (i = ee.exec(n)) && "px" !== (i[3] || "px") && (e.style[t] = n, n = b.css(e, t)), Qe(0, n, l)
            }
        }
    ...
    function it() {
        tt && (!1 === m.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(it) : e.setTimeout(it, b.fx.interval), b.fx.tick())
    }
    ...
    function lt(e, t, n) {
        var r, i, o = 0,
            ...
            l = function () {
                if (i) return !1;
                for (var t = et || ot(), n = Math.max(0, u.startTime + u.duration - t), r = 1 - (n / u.duration || 0), o = 0, a = u.tweens.length; o < a; o++) u.tweens[o].run(r);
        ...
        for (! function (e, t) {
            ...
            if (r = lt.prefilters[o].call(u, e, c, u.opts)) return h(r.stop) && (b._queueHooks(u.elem, u.opts.queue).stop = r.stop.bind(r)), r;
        return b.map(c, st, u), h(u.opts.start) && u.opts.start.call(e, u), u.progress(u.opts.progress).done(u.opts.done, u.opts.complete).fail(u.opts.fail).always(u.opts.always), b.fx.timer(b.extend(l, {
            elem: e,
            anim: u,
            queue: u.opts.queue
        })), u
    ...
    b.Animation = b.extend(lt, {
            ...
            prefilters: [function (e, t, n) {
                ...
                for (r in n.queue || (null == (a = b._queueHooks(e, "fx")).unqueued && (a.unqueued = 0, s = a.empty.fire, a.empty.fire = function () {
                    ...
                    for (r in f && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (u = m && m.display) && (u = Y.get(e, "display")), "none" === (c = b.css(e, "display")) && (u ? c = u : (ue([e], !0), u = e.style.display || u, c = b.css(e, "display"), ue([e]))), ("inline" === c || "inline-block" === c && null != u) && "none" === b.css(e, "float") && (l || (p.done((function () {
                            h.display = u
                    ...
                    }))), l = st(g ? m[r] : 0, r, p), r in m || (m[r] = l.start, g && (l.end = l.start, l.start = 0))
            }],
    ...
    b.extend(b.event, {
        trigger: function (t, n, r, i) {
            var o, a, s, l, u, f, p, d, v = [r || m],
                y = c.call(t, "type") ? t.type : t,
                x = c.call(t, "namespace") ? t.namespace.split(".") : [];
            if (a = d = s = r = r || m, 3 !== r.nodeType && 8 !== r.nodeType && !vt.test(y + b.event.triggered) && (y.indexOf(".") > -1 && (x = y.split("."), y = x.shift(), x.sort()), u = y.indexOf(":") < 0 && "on" + y, (t = t[b.expando] ? t : new b.Event(y, "object" == typeof t && t)).isTrigger = i ? 2 : 3, t.namespace = x.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + x.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : b.makeArray(n, [t]), p = b.event.special[y] || {}, i || !p.trigger || !1 !== p.trigger.apply(r, n))) {
                if (!i && !p.noBubble && !g(r)) {
                    for (l = p.delegateType || y, vt.test(l + y) || (a = a.parentNode); a; a = a.parentNode) v.push(a), s = a;
                    s === (r.ownerDocument || m) && v.push(s.defaultView || s.parentWindow || e)
                }
                for (o = 0;
                    (a = v[o++]) && !t.isPropagationStopped();) d = a, t.type = o > 1 ? l : p.bindType || y, (f = (Y.get(a, "events") || Object.create(null))[t.type] && Y.get(a, "handle")) && f.apply(a, n), (f = u && a[u]) && f.apply && U(a) && (t.result = f.apply(a, n), !1 === t.result && t.preventDefault());
                return t.type = y, i || t.isDefaultPrevented() || p._default && !1 !== p._default.apply(v.pop(), n) || !U(r) || u && h(r[y]) && !g(r) && ((s = r[u]) && (r[u] = null), b.event.triggered = y, t.isPropagationStopped() && d.addEventListener(y, yt), r[y](), t.isPropagationStopped() && d.removeEventListener(y, yt), b.event.triggered = void 0, s && (r[u] = s)), t.result
            }
        },
    ...
    _t.href = xt.href, b.extend({
        ...
        ajax: function (t, n) {
            ...
            var r, i, o, a, s, l, u, c, f, p, d = b.ajaxSetup({}, n),
                h = d.context || d,
            ...
            if (v.promise(S), d.url = ((t || d.url || xt.href) + "").replace(Lt, xt.protocol + "//"), d.type = n.method || n.type || d.method || d.type, d.dataTypes = (d.dataType || "*").toLowerCase().match(P) || [""], null == d.crossDomain) {
                l = m.createElement("a");
                try {
            ...
            if (d.data && d.processData && "string" != typeof d.data && (d.data = b.param(d.data, d.traditional)), Mt(Ht, d, n, S), u) return S;
            for (f in (c = b.event && d.global) && 0 == b.active++ && b.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !qt.test(d.type), i = d.url.replace(Nt, ""), d.hasContent ? d.data && d.processData && 0 === (d.contentType || "").indexOf("application/x-www-form-urlencoded") && (d.data = d.data.replace(At, "+")) : (p = d.url.slice(i.length), d.data && (d.processData || "string" == typeof d.data) && (i += (wt.test(i) ? "&" : "?") + d.data, delete d.data), !1 === d.cache && (i = i.replace(jt, "$1"), p = (wt.test(i) ? "&" : "?") + "_=" + bt.guid++ + p), d.url = i + p), d.ifModified && (b.lastModified[i] && S.setRequestHeader("If-Modified-Since", b.lastModified[i]), b.etag[i] && S.setRequestHeader("If-None-Match", b.etag[i])), (d.data && d.hasContent && !1 !== d.contentType || n.contentType) && S.setRequestHeader("Content-Type", d.contentType), S.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + Ot + "; q=0.01" : "") : d.accepts["*"]), d.headers) S.setRequestHeader(f, d.headers[f]);
            if (d.beforeSend && (!1 === d.beforeSend.call(h, S, d) || u)) return S.abort();
            if (C = "abort", y.add(d.complete), S.done(d.success), S.fail(d.error), r = Mt(Pt, d, n, S)) {
    ...
    b.ajaxSetup({
        ...
        if (s || "jsonp" === t.dataTypes[0]) return i = t.jsonpCallback = h(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(zt, "$1" + i) : !1 !== t.jsonp && (t.url += (wt.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function () {
            ...
            void 0 === o ? b(e).removeProp(i) : e[i] = o, t[i] && (t.jsonpCallback = n.jsonpCallback, Wt.push(i)), a && h(o) && o(a[0]), a = o = void 0
        })), "script"
    })), d.createHTMLDocument = ((Ft = m.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Ft.childNodes.length), b.parseHTML = function (e, t, n) {
        return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (d.createHTMLDocument ? ((r = (t = m.implementation.createHTMLDocument("")).createElement("base")).href = m.location.href, t.head.appendChild(r)) : t = m), o = !n && [], (i = A.exec(e)) ? [t.createElement(i[1])] : (i = xe([e], t, o), o && o.length && b(o).remove(), b.merge([], i.childNodes)));
        var r, i, o
        ...
        setOffset: function (e, t, n) {
            var r, i, o, a, s, l, u = b.css(e, "position"),
                c = b(e),
                f = {};
            "static" === u && (e.style.position = "relative"), s = c.offset(), o = b.css(e, "top"), l = b.css(e, "left"), ("absolute" === u || "fixed" === u) && (o + l).indexOf("auto") > -1 ? (a = (r = c.position()).top, i = r.left) : (a = parseFloat(o) || 0, i = parseFloat(l) || 0), h(t) && (t = t.call(e, n, b.extend({}, s))), null != t.top && (f.top = t.top - s.top + a), null != t.left && (f.left = t.left - s.left + i), "using" in t ? t.using.call(e, f) : c.css(f)
        }
    }, b.fn.extend({
        offset: function (e) {
        ...
        b.cssHooks[t] = Be(d.pixelPosition, (function (e, n) {
            if (n) return n = $e(e, t), _e.test(n) ? b(e).position()[t] + "px" : n
        }))
    })), b.each({
        Height: "height",
        Width: "width"
    ...
    }, b.isArray = Array.isArray, b.parseJSON = JSON.parse, b.nodeName = E, b.isFunction = h, b.isWindow = g, b.camelCase = V, b.type = x, b.now = Date.now, b.isNumeric = function (e) {
        var t = b.type(e);
...
const swiper = new Swiper(".swiper", {
    ...
    twoSlide = new Swiper(".customer_slider", {
        direction: "horizontal",
        slidesPerView: 2,
        navigation: {
    ...
    threeSlide = new Swiper(".swipe_slide", {
        direction: "horizontal",
        slidesPerView: 3,
        navigation: {
            nextEl: ".buttons-next",
...
mainSlider.controller.control = sliderThumbs, sliderThumbs.controller.control = mainSlider;
var slidersThumbs = new Swiper(".mySwipers", {
        direction: "horizontal",
        speed: 400,
        touchRatio: .2,
        slideToClickedSlide: !0,
    ...
    mainSliders = new Swiper(".mySwipers2", {
        parallax: !0,
        effect: "fade",
        speed: 400,
        loop: !0,
...
mainSliders.controller.control = slidersThumbs, slidersThumbs.controller.control = mainSliders;


$(document).ready((function () {
    $(window).scroll((function () {
        if(this.scrollY>100){
            $(".header_main").addClass("theme");
        }else{
            $(".header_main").removeClass("theme");
        }
    }))
}));
...
$(document).ready((function () {
    $(window).scroll((function () {
        if(this.scrollY>100){
            $(".catalog__info").addClass("fix-info");
        }else{
            $(".catalog__info").removeClass("fix-info");
        }
    }))
}));
$( ".ro" ).click(function() {
    $('.ro').addClass('lang-active');
    $('.ru').removeClass('lang-active');
  });

  $( ".ru" ).click(function() {
    $('.ru').addClass('lang-active');
    $('.ro').removeClass('lang-active');
  });

let tabs = document.querySelectorAll(".tab"),
    links = document.querySelectorAll(".tab_link"),
    links_mob = document.querySelectorAll(".link_mob");

function arr() {
    for (let e = 0; e < tabs.length; e++) tabs[e].style.display = "none", tabs[0].style.display = "block"
}
arr();
for (let e = 0; e < links.length; e++) links[e].addEventListener("click", (function () {
    for (let e = 0; e < tabs.length; e++) tabs[e].style.display = "none";
    tabs[e].style.display = "block"
})), links_mob[e].addEventListener("click", (function () {
    for (let e = 0; e < tabs.length; e++) tabs[e].style.display = "none";
    tabs[e].style.display = "block"
}));

function categories_mob() {
    document.querySelector(".categories_mob").classList.toggle("active")
}
window.addEventListener("DOMContentLoaded", () => {
    const e = document.querySelector(".header__mini__menu"),
        t = document.querySelectorAll(".header__mini__menu__item"),
        n = document.querySelector(".hamburger");
    n.addEventListener("click", () => {
        $('.header__mini__phone').toggleClass('phone-off'), n.classList.toggle("hamburger_active"), $(".header__mini").toggleClass("header_mini_off"), $('.mini-logo').toggleClass('mini-logo-src'), $('.mini-logo-src').attr('src', 'images/logo_hover.svg'), e.classList.toggle("menu_active")
    }), t.forEach(t => {
        t.addEventListener("click", () => {
            n.classList.toggle("hamburger_active"), e.classList.toggle("menu_active")
        })
    })
});
...
function play() {
    video.play(), go.style.display = "none", pause.style.display = "block"
}

function stop() {
    video.pause(), video.currentTime = 0, pause.style.display = "none", go.style.display = "block", window.location.reload()
}
player.poster = "images/item/video.jpg", window.onload = function () {
    video = document.getElementById("videoPlayer"), pause.style.display = "none"
};